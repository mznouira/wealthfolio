---
description: Implements one bounded slice from a self-contained brief. Use for code changes after a plan is approved.
mode: subagent
temperature: 0.2
permission:
  edit: allow
...
- Run the narrowest relevant verification before finishing:
  - TS: `pnpm --filter frontend lint`, `pnpm --filter frontend type-check`, `pnpm test`
